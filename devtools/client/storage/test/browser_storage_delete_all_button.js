...
add_task(async function testDeleteAllButton() {
  ...
  await performRemoveAll(["cookies", "http://test1.example.org"]);
  ...
  await performRemoveAll(["localStorage", "http://test1.example.org"]);
  ...
  await performRemoveAll(["sessionStorage", "http://test1.example.org"]);
